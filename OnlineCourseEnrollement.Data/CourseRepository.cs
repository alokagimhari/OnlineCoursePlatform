...
namespace OnlineCourseEnrollement.Data
{
    public class CourseRepository : ICourseRepository
    {
        ...
        public async Task<CourseDetailModel> GetCousesDetailsAsync(int courseId)
        {
            var course = await dbContext.Courses
                .Include(c => c.Category) //pull category
                .Include(c => c.Reviews) //pull reviews
                .Include(c => c.SessionDetails) // pull session
        ...
        {
            //build a query to dynamically apply categoryod filter if it was sent
