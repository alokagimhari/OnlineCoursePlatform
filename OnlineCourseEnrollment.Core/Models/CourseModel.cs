...
namespace OnlineCourseEnrollment.Core.Models
{
    ...
    public class CourseModel
    {
        ...
        public CourseCategoryModel? Category { get; set; } = null!;//need to show which catgory
        public UserRatingModel? UserRating { get; set; } = null!;//gather avg rating for a course
    }
